<div class="flex flex-col">
    <div class="h-32 md:h-24 bg-indigo-400 flex flex-col p-4 font-bold text-white">
    ...
    <div class="flex flex-col p-4">
        ...
        @if($location->connectors->firstWhere('type', 'iec_type_2'))
            <div class="grid grid-cols-6">
                <p class="">Icon</p>
                <p class="col-span-4">
                    {{$location?->availability?->available_iec_type_2_regular + $location?->availability?->available_iec_type_2_fast}}
                    /
                    {{$location?->availability?->total_iec_type_2_regular + $location?->availability?->total_iec_type_2_fast}}
                    available</p>
